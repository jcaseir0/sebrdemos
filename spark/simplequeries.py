...
print("1. Número de transações por cliente:")
num_transacoes.show(10)
print("2. Média de gastos por transação para cada cliente:")
media_gastos.show(10)
print("3. Clientes com maior valor de transação única:")
maior_transacao.show(10)
print("4. Total de gastos por categoria:")
gastos_categoria.show(10)
print("5. Número de transações por status:")
transacoes_status.show(10)
print("6. Clientes com transações na categoria 'Alimentação':")
clientes_alimentacao.show(10)
print("7. Total de gastos por cliente na categoria 'Transporte':")
gastos_transporte.show(10)
print("8. Clientes com transações negadas:")
clientes_negados.show(10)
print("9. Total de gastos mensais por cliente:")
