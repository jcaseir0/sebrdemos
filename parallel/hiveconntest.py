...
jar_file = 'HiveJDBC42.jar'
jar_path = 'path/to/jdbc/ClouderaHiveJDBC-2.6.25.1033'
driver_path = jar_path + '/' + jar_file
jdbc_url = 'jdbc:hive2://<hiveserver>:443/;ssl=1;transportMode=http;httpPath=<data_hub_name>/cdp-proxy-api/hive'
